...
![GitHub repo size](https://img.shields.io/github/repo-size/mashirozx/PiliPlus)
![GitHub Repo stars](https://img.shields.io/github/stars/mashirozx/PiliPlus)
...
此项目（哔哩哔哩(゜-゜)つロ干杯~-）是个人为了兴趣而开发，仅用于学习和测试，请于下载后24小时内删除。
...
<a href="https://www.star-history.com/#mashirozx/PiliPlus&Date">
 <picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=mashirozx/PiliPlus&type=Date&theme=dark" />
  <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=mashirozx/PiliPlus&type=Date" />
  <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=mashirozx/PiliPlus&type=Date" />
 </picture>
</a>
